...
>### 💻 프로젝트 개발 과정
> #### ❗️ Front End
>> - ##### 1. 각 페이지의 구성 요소(스토리 보드) 작성 후 각 페이지간의 컴포넌트 설계.
![프론트 페이지 설계](https://user-images.githubusercontent.com/52916934/74582156-68b06e00-4ffb-11ea-8a35-4fde8e82bcee.PNG)
>> - ##### 2. 컴포넌트 설계간의 부모 - 자식 관계 성립 정의 -> 효율적인 코드 작성을 위하여.
>> - ##### 3. 전체적인 디자인 설계 (CSS)
---
